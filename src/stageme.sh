...
echo  'Please run this script from the output directory where it lives: out/target/common/docs/online-sac'
echo ' '
...
/google/data/ro/projects/apphosting/tools/appcfg_over_stubby.par update online-sac
