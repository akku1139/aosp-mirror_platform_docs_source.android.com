    ...
    <ul>
     ...
     <li class="nav-section">
       ...
       <li class="nav-section">
	    ...
	    <ul>
              <li><a href="<?cs var:toroot ?>devices/tech/security/ota/ota_tools.html">OTA Tools</a></li>
              <li><a href="<?cs var:toroot ?>devices/tech/security/ota/ota_block.html">Block-based OTA</a></li>
	      <li><a href="<?cs var:toroot ?>devices/tech/security/ota/ota_inside_packages.html">Inside OTA Packages</a></li>
	      <li><a href="<?cs var:toroot ?>devices/tech/security/ota/ota_device_code.html">Device-Specific Code</a></li>
	      <li><a href="<?cs var:toroot ?>devices/tech/security/ota/ota_sign_builds.html">Signing Builds for Release</a></li>
            </ul>
            </li>
