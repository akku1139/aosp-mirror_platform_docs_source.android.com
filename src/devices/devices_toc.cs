...
<ul id="nav">
  <li class="nav-section">  <!-- Begin nav section, Device Interfaces -->
    ...
    <ul>
      ...
      <li class="nav-section">
        ...
        <ul>
          <li><a href="<?cs var:toroot ?>devices/sensors/sensor-stack.html"><span class="en">Sensor stack</span></a></li>
          <li><a href="<?cs var:toroot ?>devices/sensors/report-modes.html"><span class="en">Reporting modes</span></a></li>
          <li><a href="<?cs var:toroot ?>devices/sensors/suspend-mode.html"><span class="en">Suspend mode</span></a></li>
          <li><a href="<?cs var:toroot ?>devices/sensors/power-use.html"><span class="en">Power consumption</span></a></li>
          <li><a href="<?cs var:toroot ?>devices/sensors/interaction.html"><span class="en">Interaction</span></a></li>
          <li><a href="<?cs var:toroot ?>devices/sensors/hal-interface.html"><span class="en">HAL interface</span></a></li>
          <li><a href="<?cs var:toroot ?>devices/sensors/batching.html"><span class="en">Batching</span></a></li>
          <li><a href="<?cs var:toroot ?>devices/sensors/sensor-types.html"><span class="en">Sensor types</span></a></li>
          <li><a href="<?cs var:toroot ?>devices/sensors/versioning.html"><span class="en">Version deprecation</span></a></li>
        </ul>
      </li>
      <li class="nav-section">
        <div class="nav-section-header">
  ...
  <li class="nav-section"> <!--Begin nav-section, Core Technologies-->
    ...
    <ul>
      ...
      <li><a href="<?cs var:toroot ?>devices/tech/kernel.html"><span class="en">Kernel</span></a></li>
      <li><a href="<?cs var:toroot ?>devices/tech/low-ram.html"><span class="en">Low RAM</span></a></li>
      ...
      <li class="nav-section">
        ...
        <ul>
          ...
          <li class="nav-section">
            ...
            <ul>
              <li><a href="<?cs var:toroot ?>devices/tech/security/encryption/index.html"><span class="en">Encryption</span></a></li>
              <li class="nav-section">
                <div class="nav-section-header">
