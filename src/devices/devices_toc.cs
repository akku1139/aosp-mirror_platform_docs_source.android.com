        ...
        <ul>
         ...
         <li class="nav-section">
            ...
            <ul>
              ...
              <li><a href="<?cs var:toroot ?>devices/graphics/port-tests.html">Porting test framework</a></li>
              ...
              <li><a href="<?cs var:toroot ?>devices/graphics/test-groups.html">Special test groups</a></li>
              <li><a href="<?cs var:toroot ?>devices/graphics/cts-integration.html">Android CTS integration</a></li>
            </ul>
         </li>
        </ul>
      </li>
