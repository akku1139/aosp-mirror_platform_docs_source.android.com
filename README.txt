...
The files to be edited are located in: <root>/docs/source.android.com/src/<language-code>/
...
$ repo start <TOPIC_of_UPDATE> .

See the Repo command reference for more details:
http://source.android.com/source/using-repo.html#start

4. Add or edit the file(s) and save your changes via:
$ git add <NEW_FILE> .
$ git commit -a
$ repo upload .

5. Iteratively improve the change until you are satisfied with the language:
$ git commit -a --amend
$ repo upload .

8. Once satisfied, include the changelist in a bug filed at:
https://issuetracker.google.com/issues/new?component=191476
